...
public class MaxOpenConnectionsTests {
    ...
    public static void setup() throws Exception {
        ...
        runningNetty = tcpChannelMessage.contains("io.openliberty.netty.internal.tcp.TCPUtils");
        LOG.info("Netty? " + runningNetty);
    ...
    public void testMaxOpenConnections_invalid() throws Exception {
        ...
        HttpEndpoint httpEndpoint = configuration.getHttpEndpoints().getById("defaultHttpEndpoint");
        httpEndpoint.getTcpOptions().setMaxOpenConnections(new Integer(-1));
        ...
        // There should be at least 2 FFDCs depending on test ordering there could be more.
        assertTrue("There was not exactly two FFDCs generated!", ffdcFileNames.size() >= 2);
     ...
     * The test will set maxOpenConnections to a value of -1 and validate that is an incorrect configuration.
     *
     * The test will also update the name of the defaultHttpEndpoint to updatedHttpEndpoint and validate the
     * correct name is used in the error messages.
     *
     * The below configuration will be used to set maxOpenConnections to -1:
     * <tcpOptions maxOpenConnections="-1"/>
     *
    ...
    @AllowedFFDC("com.ibm.wsspi.channelfw.exception.ChannelException")
    @AllowedFFDC("io.openliberty.netty.internal.exception.NettyException")
    public void testMaxOpenConnections_invalid_updateEndpointName() throws Exception {
        String expectedFFDC;
        ...
        HttpEndpoint httpEndpoint = configuration.getHttpEndpoints().getById("defaultHttpEndpoint");
        httpEndpoint.setId("updatedHttpEndpoint");
        httpEndpoint.getTcpOptions().setMaxOpenConnections(new Integer(-1));
    ...
    public void testMaxOpenConnections_multiple_endpoints() throws Exception {
        ...
        endpoint2.getTcpOptions().setMaxOpenConnections(new Integer(1));
