...
import com.ibm.ws.el30.fat.servlets.EL30CoercionRulesServlet;
...
@Mode(TestMode.FULL)
public class EL30CoercionRulesTest extends FATServletClient {

    private static final String APP_NAME = "TestEL3.0";

    @Server("elServer")
    @TestServlet(servlet = EL30CoercionRulesServlet.class, contextRoot = APP_NAME)
    ...
    public static void setup() throws Exception {
        ...
        elServer.startServer(EL30CoercionRulesTest.class.getSimpleName() + ".log");
    }
