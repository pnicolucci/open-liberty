...
public class JSFSimpleHtmlUnit {
    ...
    public static void setup() throws Exception {
        ...
        ShrinkHelper.defaultDropinApp(jsfTestServer1, APP_NAME + ".war",
                                      JakartaEE10Action.isActive() ? "com.ibm.ws.jsf22.fat.simple.bean.faces40" : "com.ibm.ws.jsf22.fat.simple.bean.jsf22",
                                      JakartaEE10Action.isActive() ? "com.ibm.ws.jsf22.fat.simple.cforeach.bean.faces40" : "com.ibm.ws.jsf22.fat.simple.cforeach.bean.jsf22",
                                      "com.ibm.ws.jsf22.fat.simple.cforeach",
                                      JakartaEE10Action.isActive() ? "com.ibm.ws.jsf22.fat.simple.externalContext.faces40" : "com.ibm.ws.jsf22.fat.simple.externalContext.jsf22");

        if (JakartaEE10Action.isActive()) {
            // For Faces 4.0, CDI beans are used since ManagedBeans are no longer available.
            // When using @Named beans, a CDI feature must be enabled
