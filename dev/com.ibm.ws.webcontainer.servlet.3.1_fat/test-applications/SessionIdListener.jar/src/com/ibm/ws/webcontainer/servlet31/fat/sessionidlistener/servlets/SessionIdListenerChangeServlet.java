 ...
 *******************************************************************************/
package com.ibm.ws.webcontainer.servlet31.fat.sessionidlistener.servlets;
...
import com.ibm.ws.webcontainer.servlet31.fat.sessionidlistener.listeners.MySessionIdListener;
        ...
        if (request.getParameter("getSessionFirst") == null) {
            ...
            if (session == null) {
                ...
                try {
                    ...
                    if (e.getMessage()
                                    .trim()
                                    .equals("SRVE9014E: An attempt to change the session ID failed because no session " +
