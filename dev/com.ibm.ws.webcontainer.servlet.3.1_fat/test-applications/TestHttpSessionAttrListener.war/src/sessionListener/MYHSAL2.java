 ...
 *
 */
public class MYHSAL2 implements HttpSessionAttributeListener {

    /**
     * Default constructor.
     */
    public MYHSAL2() {
        System.out.println("MYHSAL2 construct");
    }

    @Override
    public void attributeAdded(HttpSessionBindingEvent eve) {
        System.out.println("MYHSAL2 called for the attributeAdded  in session [ " + eve.getSession() + " ]");
        CalculateListenerInvoke.addNumber();
    }

    @Override
    public void attributeRemoved(HttpSessionBindingEvent eve) {
        System.out.println("MYHSAL2 called for the attributeRemoved in session [ " + eve.getSession() + " ]");
    ...
    public void attributeReplaced(HttpSessionBindingEvent eve) {
        System.out.println("MYHSAL2 called for the attributeReplaced in session [ " + eve.getSession() + " ]");
