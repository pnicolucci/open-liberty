...
public class AsyncDispatchedServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.println("<br>*** AsyncDispatchedServlet running ***");

        async.utils.AsyncUtils.printInfo("*** AsyncDispatchedServlet ***", req, resp);

        writer.println("<br>*** AsyncDispatchedServlet completing async ***");
