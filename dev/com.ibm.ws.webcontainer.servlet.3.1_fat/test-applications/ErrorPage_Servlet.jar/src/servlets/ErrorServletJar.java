...
public class ErrorServletJar extends HttpServlet {
    /** Default serialization ID. */
    private static final long serialVersionUID = 1L;

    /** Standard constructor. */
    public ErrorServletJar() {
        super();
    }
    ...
    /** Control parameter: If present and true, do not generate an error. Simply diplay confirmation text. */
    public static final String CONFIRM_SERVLET_PARAMETER_NAME = "confirmServlet";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String confirmParam = request.getParameter(CONFIRM_SERVLET_PARAMETER_NAME);
        if ((confirmParam != null) && Boolean.valueOf(confirmParam)) {
            sos.println("Confirm Error Page Servlet");
