...
public class FATSuite extends TestContainerSuite {
    ...
    static {
        if (JavaInfo.JAVA_VERSION >= 11) {
            ...
            // For Windows,
            //    if the Java version is = 11 EE10 will be lite mode and withoutModification and EE10 will be full mode.
            //        Currently no testing is done with Java versions > 11 < 17.
            //    if the Java version is >= 17 EE11 will be lite mode and withoutModification and EE11 will be full mode.
