...
public class DefaultInjectionProviderFactory extends InjectionProviderFactory {
        ...
        try {
            if (System.getSecurityManager() != null) {
                returnValue = AccessController.doPrivileged((PrivilegedExceptionAction<Boolean>) () -> {
                    List<String> classList = ServiceProviderFinderFactory.getServiceProviderFinder(extContext).getServiceProviderList(MyfacesConfig.INJECTION_PROVIDER);
    ...
    private Object createClass(String className,
                               ExternalContext externalContext) throws InstantiationException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
    ...
    private static <T> T newInstance(Class<T> clazz) throws FacesException {
        try {
