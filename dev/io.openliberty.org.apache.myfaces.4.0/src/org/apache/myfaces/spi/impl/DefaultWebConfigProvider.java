...
public class DefaultWebConfigProvider extends WebConfigProvider {
    ...
    public List<ServletMapping> getFacesServletMappings(
        ...
        for (int i = 0; i < mapping.size(); i++) {
            org.apache.myfaces.shared_impl.webapp.webxml.ServletMapping delegateMapping = (org.apache.myfaces.shared_impl.webapp.webxml.ServletMapping) mapping.get(i);
