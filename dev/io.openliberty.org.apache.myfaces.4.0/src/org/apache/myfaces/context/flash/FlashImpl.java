...
public class FlashImpl extends Flash implements ReleasableFlash {
     ...
     */
    public static final String FLASH_PREVIOUS_REQUEST_REDIRECT = FLASH_PREFIX + ".REDIRECT.PREVIOUSREQUEST";
    ...
    private final boolean _flashScopeDisabled;
    ...
    private void _restoreMessages(FacesContext facesContext) {
        List<MessageEntry> messageList = (List<MessageEntry>) _getExecuteFlashMap(facesContext).get(FLASH_KEEP_MESSAGES_LIST);
    ...
    private void _manageFlashMapTokens(FacesContext facesContext) {
        ...
        final String previousRenderToken = _getRenderFlashMapTokenFromPreviousRequest(facesContext);
    ...
    private Map<String, Object> _getExecuteFlashMap(FacesContext context) {
        ...
        Map<String, Object> requestMap = context != null && context.getExternalContext() != null ? context.getExternalContext().getRequestMap() : null;
    ...
    private Cookie _createFlashCookie(String name, String value, ExternalContext externalContext) {
        ...
        // PAN: This is commented out until our Servlet Container implementated set(get)Attribute
        /*
