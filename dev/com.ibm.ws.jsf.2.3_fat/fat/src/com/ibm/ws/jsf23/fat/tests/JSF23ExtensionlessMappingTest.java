...
/**
 * JSF 2.3 Extensionless Mapping tests. This is not a specification defined feature like it is in Faces 4.0.
 *
 * However the Faces 4.0 specification defined feature is based off of this MyFaces feature.
 *
 */
// The Faces 4.0 FAT has a test case for the Specification defined feature.
@SkipForRepeat({ EE8_FEATURES, EE10_FEATURES })
@RunWith(FATRunner.class)
public class JSF23ExtensionlessMappingTest {
    private static final Logger LOG = Logger.getLogger(JSF23ExtensionlessMappingTest.class.getName());
    ...
    @Server("jsf23ExtensionlessMappingTest")
    ...
    public static void setUp() throws Exception {
        ...
        server.startServer(JSF23ExtensionlessMappingTest.class.getSimpleName() + ".log");
    }
    ...
    /**
     * Test that when org.apache.myfaces.AUTOMATIC_EXTENSIONLESS_MAPPING is set to true
